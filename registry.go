...
var commands = []command{
	...
	{
		Name: "ticket create", Summary: "Create a ticket assigned to the configured resource. Most new tickets should include issue-type and sub-issue-type from ticket issue-types; omit only for genuinely unclear or unusual cases.", Destructive: true,
	...
	{
		Name: "time add", Summary: "Log one time entry per clock window (e.g. split work), creating or attaching a ticket. When creating a ticket via --company, most tickets should include issue-type and sub-issue-type.", Destructive: true,
